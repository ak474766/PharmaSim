...
"[project]/node_modules/ultracontext/dist/index.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class UltraContext {
    ...
    async get(idOrOptions, options) {
        if (!idOrOptions || typeof idOrOptions === 'object') {
            ...
            return this.request(`/contexts${query ? `?${query}` : ''}`, {
                method: 'GET'
            });
        }
        const params = new URLSearchParams();
        ...
        const query = params.toString();
        return this.request(`/contexts/${encodeURIComponent(idOrOptions)}${query ? `?${query}` : ''}`, {
            method: 'GET'
        });
    }
    async update(contextId, input, options) {
        const body = options?.metadata ? {
            updates: Array.isArray(input) ? input : [
                input
            ],
...
//# sourceMappingURL=node_modules_73bdb637._.js.map